...
export default function BraveNewWorld() {
  ...
  return (
    <main className="w-full">
      ...
      {/* Hero image */}
      <img
        src="/assets/images/bnw-hero.png"
        alt="Brave New World hero"
        className="hidden md:block w-full"
        style={{ objectFit: 'cover', maxHeight: '600px' }}
      />
      <img
        src="/assets/images/bnw-hero-mobile.png"
        alt="Brave New World hero"
      ...
      <div className="w-full max-w-[1200px] mx-auto px-6 md:px-16 py-12">
        ...
        >
          Digital Design, Creative Software Usage
        </p>
        ...
        >
          ...
          >
            oil pants, acrylics, watercolor, etc
          </Link>
        ...
        <div className="hidden md:block mb-16">
          <div className="grid grid-cols-2 gap-8">
            {/* Left column: book cover + tablet mockup */}
            ...
            {/* Right column: audiobook cover + phone mockup */}
            <div className="flex flex-col gap-8">
