...
export default function PawPal() {
  ...
  return (
    <main className="w-full">
      ...
      <img src="/assets/images/pawpal-hero.png" alt="PawPal hero" className="hidden md:block w-full" style={{ objectFit: 'cover', maxHeight: '600px' }} />
      <img src="/assets/images/pawpal-hero-mobile.png" alt="PawPal hero" className="md:hidden w-full" style={{ marginTop: '20px' }} />

      <div className="w-full max-w-[1200px] mx-auto px-6 md:px-16 py-12">

        <FadeIn>
          <h1 style={{ fontFamily: 'var(--font-display)', fontSize: 'clamp(40px, 8vw, 100px)', color: '#111E33', lineHeight: '1', marginBottom: '8px' }}>PAWPAL</h1>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.5vw, 20px)', color: '#111E33', marginBottom: '60px' }}>Mobile App Design, Prototyping, User Interviews, UX Research</p>
        </FadeIn>
        ...
        <FadeIn delay={0.1}>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.8vw, 28px)', color: '#111E33', lineHeight: '1.6', marginBottom: '24px' }}>
        ...
        <FadeIn delay={0.2}>
          <a href={figmaLink} target="_blank" rel="noopener noreferrer" style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.5vw, 22px)', color: '#1D7194', textDecoration: 'underline', display: 'block', marginBottom: '40px' }}>
            High-Fidelity Prototype
          </a>
        </FadeIn>

        <FadeIn>
          <h2 style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(22px, 3vw, 45px)', fontWeight: 'bold', color: '#111E33', marginBottom: '16px' }}>Team</h2>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.8vw, 28px)', color: '#111E33', marginBottom: '60px' }}>MD Sami Zaif, Emily Inga, Anushka Anand, and Alexia Kouletsis</p>
        </FadeIn>
        ...
        <FadeIn>
          <h2 style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(22px, 3vw, 45px)', fontWeight: 'bold', color: '#111E33', marginBottom: '40px' }}>Step 1 | User Research</h2>
          <h3 style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(18px, 2.5vw, 38px)', fontStyle: 'italic', fontWeight: 'bold', color: '#111E33', marginBottom: '32px' }}>Interviews</h3>
        </FadeIn>
        ...
        <FadeIn>
          <h3 style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(18px, 2.5vw, 38px)', fontStyle: 'italic', fontWeight: 'bold', color: '#111E33', marginBottom: '32px' }}>Key Interview Quotes</h3>
        </FadeIn>

        <FadeIn delay={0.1}>
          <div className="hidden md:grid grid-cols-2 gap-12 mb-16">
            <div className="flex flex-col gap-8">
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.8vw, 28px)', color: '#111E33', lineHeight: '1.6' }}>"It's just the little things that make the biggest difference into being a more social person."</p>
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.8vw, 28px)', color: '#111E33', lineHeight: '1.6' }}>"If I'm doing too much socially, it doesn't leave room for academics or working out. And then if I'm working out and doing too much schoolwork to the point where I don't give myself time [for socializing], then it's just kind of sad."</p>
            </div>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.8vw, 28px)', color: '#111E33', lineHeight: '1.6' }}>"I feel like a lot of loneliness has to do with self action. It's less of a fact about 'does Northeast have resources', but more of a fact about, like, how can Northeastern teach you how to reach social interactions as a person by yourself?"</p>
          </div>
          <div className="md:hidden flex flex-col gap-6 mb-10">
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '12px', color: '#111E33', lineHeight: '1.6' }}>"I feel like a lot of loneliness has to do with self action. It's less of a fact about 'does Northeast have resources', but more of a fact about, like, how can Northeastern teach you how to reach social interactions as a person by yourself?"</p>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '12px', color: '#111E33', lineHeight: '1.6' }}>"It's just the little things that make the biggest difference into being a more social person."</p>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '12px', color: '#111E33', lineHeight: '1.6' }}>"If I'm doing too much socially, it doesn't leave room for academics or working out. And then if I'm working out and doing too much schoolwork to the point where I don't give myself time [for socializing], then it's just kind of sad."</p>
          </div>
        </FadeIn>

        <FadeIn>
          <h3 style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(18px, 2.5vw, 38px)', fontStyle: 'italic', fontWeight: 'bold', color: '#111E33', marginBottom: '24px' }}>Affinity Diagramming and User Personas</h3>
        </FadeIn>
        <FadeIn delay={0.1}>
        ...
        <FadeIn>
          <h2 style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(22px, 3vw, 45px)', fontWeight: 'bold', color: '#111E33', marginBottom: '24px' }}>Step 2 | Low-Fidelity Prototype</h2>
        </FadeIn>
        <FadeIn delay={0.1}>
        ...
        <FadeIn>
          <h2 style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(22px, 3vw, 45px)', fontWeight: 'bold', color: '#111E33', marginBottom: '24px' }}>Step 3 | High-Fidelity Prototype</h2>
        </FadeIn>
        <FadeIn delay={0.1}>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.8vw, 28px)', color: '#111E33', lineHeight: '1.6', marginBottom: '24px' }}>
        ...
        <FadeIn delay={0.2}>
          <a href={figmaLink} target="_blank" rel="noopener noreferrer" style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.5vw, 22px)', color: '#1D7194', textDecoration: 'underline', display: 'block', marginBottom: '24px' }}>
            Click here to play with the final Figma prototype yourself!
          </a>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 'clamp(12px, 1.8vw, 28px)', color: '#111E33', marginBottom: '24px' }}>Video demonstration:</p>
          <video controls className="w-full rounded-lg mb-16" style={{ maxHeight: '600px' }}>
