...
export default function Goodkarma() {
  ...
  return (
    <main className="w-full">
      ...
      {/* Hero image */}
      <img
        src="/assets/images/goodkarma-hero.png"
        alt="Goodkarma hero"
        className="hidden md:block w-full"
        style={{ objectFit: 'cover', maxHeight: '600px' }}
      />
      <img
        src="/assets/images/goodkarma-hero-mobile.png"
        alt="Goodkarma hero"
      ...
      <div className="w-full max-w-[1200px] mx-auto px-6 md:px-16 py-12">
        ...
        >
          Web Development, Web Design, Prototyping, Client Collaboration
        </p>
        ...
        {/* Desktop moodboard layout */}
        <div className="hidden md:block mb-16">

          {/* Row 1: two moodboards with arrow between */}
          ...
          {/* Row 2: text under each moodboard */}
          ...
          {/* Row 3: moodboard 3 left, naomi text + down arrow + palette right */}
